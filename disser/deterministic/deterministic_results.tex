...
A distance of \mbox{400 km} was used as the search radius over which to look for the location of observed accumulations of at least \mbox{25.4 mm} in \mbox{6 hr} relative to forecast accumulations of the same.
...
When the anisotropic Gaussian function is fit to this distribution, the resulting parameters, determined by the methods discussed in \mbox{chapter \ref{method}} as well as in \cite{Lak2010}, are $(\mu_x, \mu_y) = (4.7, 18.8)$ km, indicating that the NSSL-WRF forecasts were, on average, approximately \mbox{4.7 km} too far west and \mbox{18.8 km} too far south, $\sigma_x \approx 190$ km, $\sigma_y \approx 155$ km, and $\theta \approx 60^{\circ}$ in the counter-clockwise direction, revealing the anisotropy of the distribution.
To some extent, the shape and anisotropy are closely related to the mean shape and orientation of individual precipitation objects.
This was suspected on the basis of subjective assessments and confirmed by applying the Baldwin object identification algorithm \citep{Baldwin2005}.
In particular, heavy precipitation features are often observed to have a southwest-to-northeast orientation.
...
\mbox{Figure \ref{single_1_400km_25mm}a}, \mbox{\ref{single_1_400km_25mm}c}, and \mbox{\ref{single_1_400km_25mm}e} depict observations and model forecasts of precipitation for the \mbox{6 hours} ending 18 UTC 02 May 2010 (a 12-18 hr forecast).
...
A 24-30 hr forecast and observations of precipitation for the \mbox{6 hours} ending 06 UTC 06 June 2010 are presented in \mbox{Figures \ref{single_2_400km_25mm}a}, \mbox{\ref{single_2_400km_25mm}c}, and \mbox{\ref{single_2_400km_25mm}e}.
...
The fitted anisotropic Gaussian function has parameters $(\mu_x, \mu_y) = (9.4, 14.1)$ km, indicating that the NSSL-WRF forecasts were, on average, approximately \mbox{9.4 km} too far west and \mbox{14.4 km} too far south, $\sigma_x \approx 190$ km, $\sigma_y \approx 170$ km, and $\theta \approx 50^{\circ}$ in the counter-clockwise direction.
The fitted function at the \mbox{12.7 mm} threshold is close to isotropic as compared to the \mbox{25.4 mm} threshold function.
This is most likely a result stemming from using a lower precipitation threshold.
The lower precipitation threshold is achieved more frequently, resulting in more grid points being considered as ``events''.
More events create a wider composite at the \mbox{12.7 mm} threshold than at the greater \mbox{25.4 mm} threshold.


Examples of the forecasts produced by the calibration method are shown in \mbox{Figures \ref{single_1_400km_12mm} and \ref{single_2_400km_12mm}}.
...
The most notable difference is that probability values are greater.
