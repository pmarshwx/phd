...
\begin{figure}[cc]
    ...
    \caption{Relative Operating Characteristic curve (a) and reliability diagram with corresponding forecast counts (b), both computed over the 01 April 2010 to 31 March 2011 time period.
    On the ROC curve, the area under curve $(AUC = 0.94)$ and line of no skill (diagonal; dashed) are also plotted.
    The reliability component of the Brier Score ($REL = 1.3898 \times 10^{-5}$; \citealp{Murphy1973}), line of perfect reliability (diagonal; dashed) and line of no skill (dot-dash line) are also plotted on the reliability diagram.
    The climatology line is plotted, but because it is less than 0.005 it cannot be distinguished from the x-axis.
