...
\begin{figure}[ht]
    \centering
    \includegraphics[width=35pc, angle=0]{./deterministic/figs/single_member_sample_forecast1.pdf}\\
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=35pc, angle=0]{./deterministic/figs/single_member_sample_forecast2.pdf}\\
...
\begin{figure}[ht]
    \centering
    \noindent\includegraphics[width=35pc, angle=0]{./deterministic/figs/single_roc_rely.pdf}\\
