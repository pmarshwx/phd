...
\begin{center}
    ...
    \begin{longtable}{|c|c|c|c|c|c|c|}
        ...
        The \emph{arw} prefix is indicative of WRF-ARW members, \emph{nmm} is indicative of WRF-NMM members, and \emph{arps} is indicative of ARPS members.
        The suffix \emph{cn} indicates a control member, whereas a suffix of \emph{mX}, where X is a number, indicates a perturbation.}
...
\begin{figure}[cc]
    \centering
    \includegraphics[width=\textwidth, height=\textheight, keepaspectratio]{%
    ./ensemble/figs/ssef_25mm_400km_mu_x.png}\\
    \caption{The same as in \mbox{Figure \ref{sigmax-25mm-400km-dist}}, except for fitting parameter $\mu_x$, corresponding to east-west displacement of forecasts.}
    \label{mu_x-25mm-400km-dist}
\end{figure}
...
\begin{figure}[cc]
    \centering
    \includegraphics[width=\textwidth, height=\textheight, keepaspectratio]{%
    ./ensemble/figs/ssef_25mm_400km_mu_y.png}\\
    \caption{The same as in \mbox{Figure \ref{sigmax-25mm-400km-dist}}, except for fitting parameter $\mu_y$, corresponding to north-south displacement of forecasts.}
    \label{mu_y-25mm-400km-dist}
\end{figure}
...
\begin{figure}[cc]
    ...
    The red curve depicts the verification of the modified Hamill and Colucci probabilistic forecasts.
    }
...
\begin{figure}[cc]
    \centering
    \includegraphics[width=\textwidth, height=\textheight, keepaspectratio]{%
    ./ensemble/figs/ssef_12mm_400km_mu_x.png}\\
    \caption{The same as in \mbox{Figure \ref{mu_x-25mm-400km-dist}}, except for threshold \mbox{12.7 mm} in \mbox{6 hr}.}
    \label{mu_x-12mm-400km-dist}
\end{figure}
...
\begin{figure}[cc]
    \centering
    \includegraphics[width=\textwidth, height=\textheight, keepaspectratio]{%
    ./ensemble/figs/ssef_12mm_400km_mu_y.png}\\
    \caption{The same as in \mbox{Figure \ref{mu_y-25mm-400km-dist}}, except for threshold \mbox{12.7 mm} in \mbox{6 hr}.}
    \label{mu_y-12mm-400km-dist}
\end{figure}
