...
A quick examination of the standard deviation of the two-dimensional composites quickly shows that the two-dimensional composites appear to be more uniform than at the \mbox{25.4 mm} threshold.
...
The period from late Spring through Summer is traditionally the hardest time for numerical weather prediction with respect to quantitative precipitation forecasts!
...
If the resulting two-dimensional composite is unable to adequately represent the displacement error, the method will not produce as well of a forecast as it could.
