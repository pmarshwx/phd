...
Consistency, sometimes referred to as type 1 ``goodness'', is a measure of correspondence between the actual forecast and the forecaster's judgment of what will occur.
Quality, sometimes referred to as type 2 ``goodness'', is a measure of correspondence between the forecast and the observations.
Value, known as type 3 ``goodness'', is a measure of the benefit a forecast provides to users of the forecast.
...
Raw deterministic model output can be thought of in terms of probabilities.
A single value can be thought of having a probability of 1 that value will be observed, and a 0 that any other value will be observed.
...
\cite{Bjerknes1904} first recognized that in order to produce numerical forecasts of subsequent states of the atmosphere:
\begin{enumerate}
