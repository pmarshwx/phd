\documentclass[figures, times]{outhesis}
...
\input{./deterministic_method/deterministic_method.tex}
\input{./deterministic_data/deterministic_data.tex}
\input{./deterministic_results/deterministic_results.tex}
\input{./ensemble_method/ensemble_method.tex}
\input{./ensemble_data/ensemble_data.tex}
\input{./ensemble_results/ensemble_results.tex}

\begin{oubibliography}
    \bibliographystyle{ametsoc}
    \bibliography{./bib/dissertation}
\end{oubibliography}
% \references{ametsoc}{./bib/dissertation.bib}
